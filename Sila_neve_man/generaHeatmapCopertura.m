function [Matrice_Potenza_HM, figura_HM] = generaHeatmapCopertura(X_metri, Y_metri, F_dem, ...
   ...
   % 3. Render Grafico della Heatmap
    figura_HM = figure('Name', 'Heatmap della Potenza Ricevuta (con RET + Neve)', 'Color', 'w', 'Position', [150, 150, 800, 600]);
    ...
    title('Heatmap della Potenza Ricevuta (RET + Neve)', 'FontSize', 12, 'FontWeight', 'bold');
