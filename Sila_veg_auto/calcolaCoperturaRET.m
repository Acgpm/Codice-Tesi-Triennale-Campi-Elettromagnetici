function potenza_min = calcolaCopertura(drone_X, drone_Y, drone_Z, ...
    ...
    nPuntiRaggio = 50; % Risoluzione ridotta per accelerare la Grid Search
    ...
    % La logica Max-Min Fairness richiede di valutare la condizione peggiore
